#!/usr/bin/env python3
"""
train_florence2_v7_1.py
=======================
Florence-2-large fine-tuning v7.1 — Balanced recall fix.
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="./checkpoints_v7_1")
    ...
    print(f"\n{'='*60}")
    print("STARTING TRAINING (v7.1 — Balanced Recall Fix)")
    print(f"{'='*60}\n")
